...
public abstract class Tunnel {
    ...
    public void connect(InetSocketAddress destAddress) throws Exception {
        if (LocalVpnService.Instance.protect(m_InnerChannel.socket())) {//保护socket不走vpn
            ...
            if (ProxyConfig.IS_DEBUG) {
                System.out.printf("RemoteTunnel connect destAddress %s\n", m_DestAddress);
                System.out.printf("RemoteTunnel connect innerChannel %s\n", m_InnerChannel);
                System.out.printf("RemoteTunnel connect serverEP %s\n", m_ServerEP);
            }
        } else {
    ...
    public String toString() {
        if (ProxyConfig.IS_DEBUG) {
            System.out.printf("Tunnel innerChannel %s\n", m_InnerChannel);
            System.out.printf("Tunnel serverEP %s\n", m_ServerEP);
            System.out.printf("Tunnel destAddress %s\n", m_DestAddress);
            //System.out.printf("Tunnel browtherTunnel\n");
            //System.out.printf(m_BrotherTunnel.toString());
        }
