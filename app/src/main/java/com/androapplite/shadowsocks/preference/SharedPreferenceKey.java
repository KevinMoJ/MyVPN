...
public final class SharedPreferenceKey {
    ...
    public static final String LUCK_PAN_GET_FREE_DAY = "LUCK_PAN_GET_FREE_DAY"; // 幸运转盘转出的时间，存的是天，用来去判断进度条和当天旋转得到的时间
    ...
    public static final String LUCK_PAN_DIALOG_SHOW_COUNT = "LUCK_PAN_DIALOG_SHOW_COUNT"; // 幸运转盘dialog弹出的次数
