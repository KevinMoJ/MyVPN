...
public class LuckRotateProgressBar extends View {
...
//    private int paddingStart = 10,paddingEnd = 0;
    ...
    public LuckRotateProgressBar(Context context) {
        super(context);
        init();
    }


    public LuckRotateProgressBar(Context context, AttributeSet attrs) throws Exception {
        super(context, attrs);
        //获取xml属性
    ...
    public LuckRotateProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
